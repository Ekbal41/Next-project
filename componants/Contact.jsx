...
<div className="container-fluid ">
    <div className="row g-0">
        <div className="col-md-6 text-center d-flex flex-column justify-content-center min-vh-50 ">
        ...
        <div className="col-md-6 bg-primary text-white d-flex flex-column justify-content-center text-center py-5">
            <div className="lc-block mb-4 border-bottom border-white py-4">
                ...
                <div className="lc-block">
                    <div editable="rich">
                        <p className="lead">901-773-4045<br/></p>
                    </div>
                </div>
            ...
            <div className="lc-block py-4">
                ...
                <div className="lc-block">
                    <div editable="rich">
                        <p className="lead">mail@yourdomain.com<br/></p>
                    </div>
                </div>
