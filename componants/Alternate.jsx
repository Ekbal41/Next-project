		...
		<div className="col-lg-6 p-lg-6">
			<div className="lc-block mb-5">
				<div editable="rich">
					...
					<h2 className="display-6 fw-bold title">Boost your Creativity</h2>

					<p className="lead subtitle"><br/>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse a lacus est. Etiam diam metus.</p>
				</div>
			</div>
			...
			<div className="lc-block">
				<div className="d-inline-flex">
					...
					<div className="ms-3 align-self-center subtitle" editable="rich">
		...
		<div className="col-lg-6 p-lg-6">
			<div className="lc-block mb-5">
				<div editable="rich">
					...
					<h2 className="display-6 fw-bold title">Increase your Sales</h2>
